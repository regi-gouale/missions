    ...
    elements: [
      {
        type: "radiogroup",
        name: "gagneurAmes-8",
        title: "J'annonce le Christ sans trop tourner longtemps autour du pot.",
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        type: "radiogroup",
        name: "gagneurAmes-10",
        title: "J’aime avoir une vision dynamique des choses.",
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        type: "radiogroup",
        name: "gagneurAmes-21",
        title: "Je reste constamment en quête de stratégies d’évangélisation.",
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        ...
        title: "Ma communication est orientée sur la vie des âmes.",
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        ...
        title: `Lors du passage à la maison d'un frère dans la foi ou d'un prédicateur, j'invite des amis ou des voisins à le rencontrer chez moi.`,
    ...
    elements: [
      {
        ...
        title: `Plusieurs personnes ont été gagnées au Seigneur au travers de leur amitié avec moi.`,
    ...
    elements: [
      {
        ...
        title: `Je me tiens au courant des nouveautés missionnaires (rassemblements, livres, témoignages, vidéo ou prédication sur Internet, etc.), puis j'essaye de voir à qui je pourrais les proposer.`,
    ...
    elements: [
      {
        ...
        title: `Je m'attache à démontrer que la foi chrétienne et la Révélation apportent des réponses pertinentes aux dérives et aux besoins du monde moderne.`,
    ...
    elements: [
      {
        ...
        title: `L’organisation et la planification sont des activités que j’apprécie énormément dans la mission.`,
    ...
    elements: [
      {
        ...
        title: `Lorsque j'arrive sur un champ missionnaire, j'apprécie qu'il y ait une organisation déjà établie.`,
    ...
    elements: [
      {
        ...
        title: `Dans le cadre de la mission, je préfère trouver des solutions face aux défis organisationnels.`,
    ...
    elements: [
      {
        ...
        title: `Je me sens à l’aise dans la formulation de remarques constructives et utiles.`,
    ...
    elements: [
      {
        ...
        title: `Je me sens plus à l’aise à travailler avec des concepts, des stratégies à développer.`,
    ...
    elements: [
      {
        ...
        title: `Ma communication est orientée sur les objectifs à atteindre, le statut des églises, le territoire.`,
    ...
    elements: [
      {
        ...
        title: `Pour moi le terme conquête signifie multiplication des églises dans une zone déterminée.`,
    ...
    elements: [
      {
        ...
        title: `Les temps de prière sont généralement orientés sur la prise de territoires.`,
    ...
    elements: [
      {
        ...
        title: `J’aime que la mission soit une réussite, je m’assure que toute l’organisation soit conforme à la vision du pasteur.`,
    ...
    elements: [
      {
        ...
        title: `J’éprouve une frustration lorsque la dynamique d’évangélisation n’est pas suivie.`,
    ...
    elements: [
      {
        ...
        title: `Le respect de l’heure, du timing est déterminant pour moi lors de nos réunions.`,
    ...
    elements: [
      {
        ...
        title: `Je suis très regardant sur le bon déroulement du programme.`,
    ...
    elements: [
      {
        ...
        title: `Je m’assure que le budget est respecté.`,
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        ...
        title: `Je reste fortement sensible au changement et à l’innovation.`,
    ...
    elements: [
      {
        ...
        title: `J'aime évangéliser les personnes blessées ou éloignées de Dieu pour leur annoncer Son amour et Sa compassion pour chacun.`,
    ...
    elements: [
      {
        ...
        title: `Je veille à ce que les non-croyants et les personnes extérieures à la communauté chrétienne soient très bien accueillies.`,
    ...
    elements: [
      {
        ...
        title: `Quand je rencontre des personnes vivant le type de galères ou d'épreuves que je vivais avant de rencontrer Jésus, je leur témoigne de ce qui m'est arrivé grâce à Lui.`,
    ...
    elements: [
      {
        ...
        title: `Je me reconnais bien dans la figure de la Samaritaine : après avoir rencontré et écouté Jésus, elle invite tout le village à faire de même.`,
    ...
    elements: [
      {
        ...
        title: `Je ne peux évangéliser que si je me sens bien dans ma relation avec le Seigneur, autrement j’ai du mal.`,
    ...
    elements: [
      {
        ...
        title: `Je suis émerveillé par la façon dont Jésus m'a conduit à Lui ; je suis poussé à le partager aux autres pour qu'ils perçoivent combien Jésus est vivant aujourd'hui.`,
    ...
    elements: [
      {
        ...
        title: `Je suis profondément bouleversé par la détresse des hommes qui ne connaissent pas le Christ et par les mensonges de ce monde.`,
    ...
    elements: [
      {
        ...
        title: `J'ai un caractère liant, sympathique et spontané avec les personnes inconnues ou éloignées de la communauté chrétienne.`,
    ...
    elements: [
      {
        ...
        title: `J’aime prendre soin des âmes, les mettre à l’aise et connaitre leurs besoins.`,
    ...
    elements: [
      {
        ...
        title: `Lorsque j'évangélise, je parle d'abord de l'immense amour de Dieu pour chacun.`,
    ...
    elements: [
      {
        ...
        title: `Je partage aisément aux autres ma joie d'avoir participé à un évènement où se sont manifestés clairement la grâce et l'amour de Dieu.`,
    ...
    elements: [
      {
        ...
        title: `J'annonce avant tout l'amour de Dieu afin de rejoindre le besoin de chacun d'aimer et d'être aimé.`,
    ...
    elements: [
      {
        ...
        title: `Pour évangéliser quelqu'un, je cherche d'abord à comprendre les raisons de ses doutes, de son indifférence ou de son refus de croire.`,
    ...
    elements: [
      {
        ...
        title: `J’ai une facilité à donner, donc je privilégie tout ce qui est lié aux actes de compassion.`,
    ...
    elements: [
      {
        ...
        title: `Je mets l’accent sur des programmes destinés à rendre visite aux personnes en difficultés.`,
    ...
    elements: [
      {
        ...
        title: `Je suis plus sensible à la mobilisation des ressources en vue de venir en aide aux personnes en difficulté.`,
    ...
    elements: [
      {
        ...
        title: `Ma communication est orientée sur la communion fraternelle, les dons, les appels à l’aide.`,
    ...
    elements: [
      {
        ...
        title: `Pour moi le terme conquête signifie manifestation massive des actes de compassion.`,
    ...
    elements: [
      {
        ...
        title: `Les temps de prière sont généralement orientés sur la dimension du Dieu Pourvoyeur et du Dieu Amour.`,
    ...
    elements: [
      {
        ...
        title: `Les personnes me disent qu'elles sont touchées par mon attention à elles et par les services que je leur rends.`,
    ...
    elements: [
      {
        ...
        title: `Quand je rencontre une personne qui souffre, je m'attache à la rejoindre par des gestes d'attention, de consolation ou d'affection.`,
    ...
    elements: [
      {
        ...
        title: `J'accepte facilement d'être dérangé pour me mettre au service et à l'écoute de ceux qui font appel à moi.`,
    ...
    elements: [
      {
        ...
        title: `Je suis étreint par la tristesse ou l'angoisse de ceux qui ne vivent pas de la grâce de Dieu.`,
    ...
    elements: [
      {
        ...
        title: `Je ne peux pas concevoir qu’il y ait parmi nous des personnes qui rencontrent des difficultés.`,
    ...
    elements: [
      {
        ...
        title: `Sur le champ missionnaire, je me concentre sur les besoins des âmes.`,
    ...
    elements: [
      {
        type: "radiogroup",
        name: "itinerant-1",
        title: `Je préfère aller sur le terrain.`,
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        type: "radiogroup",
        name: "itinerant-2",
        title: `J’aime découvrir de nouveaux territoires, voyager, être sur les routes.`,
    ...
    elements: [
      {
        type: "radiogroup",
        name: "itinerant-3",
        title: `Je privilégie le contact direct avec les âmes.`,
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        type: "radiogroup",
        name: "itinerant-4",
        title: `Je peux partir d’un champ missionnaire vers un autre sans souci.`,
    ...
    elements: [
      {
        type: "radiogroup",
        name: "itinerant-5",
        title: `J’aime me déplacer très souvent`,
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        type: "radiogroup",
        name: "sedentaire-1",
        title: `Je préfère piloter les activités à distance.`,
        isRequired: true,
        choices: choices,
      },
    ],
    ...
    elements: [
      {
        type: "radiogroup",
        name: "sedentaire-2",
        title: `J’aime plutôt effectuer des tâches administratives en rapport avec la mission.`,
    ...
    elements: [
      {
        type: "radiogroup",
        name: "sedentaire-3",
        title: `Je me sens à l’aise lorsque le contact se fait à distance.`,
    ...
    elements: [
      {
        type: "radiogroup",
        name: "sedentaire-4",
        title: `Je préfère finir sur un champ missionnaire avant d’être déployé ailleurs.`,
